      ...
      <Container className="max-w-4xl">
        <FadeIn>
          ...
          <div className="prose prose-stone max-w-none text-stone-600 font-light leading-relaxed">
            ...
            <p className="mb-6">
              Este sitio web tiene como finalidad informar sobre los servicios de reformas integrales y construcción de Reformas Maki.
            </p>
            <p>
              El acceso y uso de la web atribuye la condición de usuario e implica la aceptación plena y sin reservas de las condiciones aquí expuestas. El usuario se compromete a hacer un uso adecuado de los contenidos y servicios que Reformas Maki ofrece a través de su portal y a no emplearlos para incurrir en actividades ilícitas, ilegales o contrarias a la buena fe y al orden público.
            </p>
          </div>
        </FadeIn>
      </Container>
